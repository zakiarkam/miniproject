...
export const sendMail = async ({ email, emailType, userId }) => {
  try {
    ...
    const sendEmailTransporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "eventsnow.project.ruchith@gmail.com",
        pass: "zrba iwuu xfel fyky",
    ...
    const mailOptions = {
                            ...
                            <tr>
                              <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 20px; padding-top: 15px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                  ...
                                  <tr>
                                    <td class="pad" style="padding-bottom:5px;padding-left:5px;padding-right:5px;width:100%;">
                                      <div class="alignment" align="center" style="line-height:10px">
                                        <div style="max-width: 250px;"><img src="https://596cb46884.imgdist.com/pub/bfra/psv8i919/sr6/boi/uxj/email-icon-button-web-internet-2151046.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="250" alt="reset-password" title="reset-password" height="auto"></div>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
                                ...
                                <table class="paragraph_block block-3" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                  <tr>
                                    <td class="pad">
                                      <div style="color:#393d47;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:12px;line-height:150%;text-align:center;mso-line-height-alt:18px;">
                                        <p style="margin: 0; word-break: break-word;">Welcome to EventNow.please click below button to verify your email address</p>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
      ...
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${process.env.NEXTAUTH_URL}/verifyemail?token=${hashedToken}" style="height:43px;width:299px;v-text-anchor:middle;" arcsize="47%" stroke="false" fillcolor="#ff7426">
      <w:anchorlock/>
      <v:textbox inset="0px,0px,0px,0px">
      <center dir="false" style="color:#ffffff;font-family:Arial, sans-serif;font-size:18px">
      <![endif]--><a href="${process.env.NEXTAUTH_URL}/verifyemail?token=${hashedToken}" target="_blank" style="background-color:#ff7426;border-bottom:0px solid #000000;border-left:0px solid #000000;border-radius:20px;border-right:0px solid #000000;border-top:0px solid #000000;color:#ffffff;display:inline-block;font-family:'Oswald', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:18px;font-weight:undefined;mso-border-alt:none;padding-bottom:10px;padding-top:10px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;"><span style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span style="word-break:break-word;"><span style="line-height: 21.6px;" data-mce-style><strong>VERIFY MY EMAIL ADDRESS</strong></span></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
                                    </td>
                                  </tr>
                                </table>
                                  ...
                                  <tr>
                                    <td class="pad">
                                      <div style="color:#393d47;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:10px;line-height:120%;text-align:center;mso-line-height-alt:12px;">
                                        <p style="margin: 0; word-break: break-word;"><span>This link will expire in 01 hour. If you continue to have problems</span><br><span>please feel free to contact us at eventsnow.project.ruchith@gmail.com. </span></p>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
    ...
    const mailResponse = await sendEmailTransporter.sendMail(mailOptions);
    return mailResponse;
  } catch (err) {
